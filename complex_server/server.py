...
def start_service():
    ...
    # dispatcher.connect('hp_get_cid','/hp/cid/:cid', controller=hpController, action='GET_CID', conditions=dict(method=['GET']))
    ...
    #get_name
    # dispatcher.connect('hp_get_character_name','/hp/name/:char_name', controller=hpController, action='GET_NAME', conditions=dict(method=['GET']))
    #delete_cid
    # dispatcher.connect('hp_delete_key','/hp/cid/:cid', controller=hpController, action='DELETE_CID', conditions=dict(method=['DELETE']))
    ...
    #delete_name
    # dispatcher.connect('hp_delete_character_name','/hp/name/:char_name', controller=hpController, action='DELETE_NAME', conditions=dict(method=['DELETE']))
    #post_new_character
